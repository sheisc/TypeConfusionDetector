...
#if 1
extern llvm::cl::opt<bool> EnableCastStub;
#endif
...
#if 1
  void AddMetadataForUNSWStubCallInst(llvm::CallInst *call, llvm::Type *srcTy, llvm::Type *dstTy);
  llvm::CallInst * EmitUNSWStubFun(StringRef FunName, ArrayRef<llvm::Value *> Args);
  //void EmitUNSWStubFun(StringRef FunName, ArrayRef<llvm::Value *> Args);
  llvm::CallInst * EmitUNSWNewExpression(StringRef FunName, ArrayRef<llvm::Value *> DynamicArgs);
#endif                 
