...
#if 1 // commented 2018.11.14
    return fun && fun->getName().str() == "main";
#endif
#if 0
    return fun && fun->getName().str() == "svf.main";
#endif
}
...
llvm::Instruction * findNextInstruction(llvm::Instruction *CurInst);
#if 1 // added 2018.11.12
llvm::Type * getAbstractObjectType(llvm::Value * val);
llvm::StructType * getBaseStructType(llvm::Value * val);
Size_t getFldIdxViaByteOffset(llvm::StructType * baseTy,Size_t byteoffset);
llvm::Type * getInnermostType(llvm::Type * ty);
